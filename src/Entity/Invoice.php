...
class Invoice
{
     ...
     *@Assert\NotBlank(message="la date d'envoie doit etre renseignee !!")
     */
    private $sentAt;
     ...
     * @groups({"invoices_read","customers_read","invoices_subresource"})
     * @Assert\NotBlank(message="le status de la facture doit etre renseignee !!")
     * @Assert\Choice(choices={"SENT","PAID","CANCELLED"},message="le ststus doit etre SENT,PAID ou CANCELLED")
     */
    private $status;
     ...
     * @Assert\NotBlank(message="le client de la facture doit etre renseignee !!")
     */
    private $customer;
